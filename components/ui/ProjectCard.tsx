...
const ProjectCard = React.memo(function ProjectCard({
  ...
  return (
    <div className="group relative flex flex-col h-full rounded-3xl overflow-hidden project-glass-card transition-[box-shadow,border-color,background-color] duration-300 shadow-lg hover:shadow-2xl hover:border-accent/40 hover:bg-card/60">
      {/* Decorative Glow */}
